...
color: ""                   Hex color for terminal output (e.g., "BB")
...
persona:
  ...
  background: ""            -sentence summary of who they are
...
[Rich narrative backstory — -words. Cover: origin, formative experiences,
...
- [Trait — brief explanation of how it manifests]
- [Trait — brief explanation]
- [Trait — brief explanation]
- [Trait — brief explanation]
- [Trait — brief explanation]
...
"[Example phrase ]" | "[Example phrase ]" | "[Example phrase ]"
