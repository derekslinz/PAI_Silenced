...
Prompt engineering
This guide shares strategies and tactics for getting better results from large language models (sometimes referred to as GPT models) like GPT-. The methods described here can sometimes be deployed in combination for greater effect. We encourage experimentation to find the methods that work best for you.

Some of the examples demonstrated here currently work only with our most capable model, gpt-. In general, if you find that a model fails at a task and a more capable model is available, it's often worth trying again with the more capable model.
...
If asked to multiply by , you might not know it instantly, but can still work it out with time. Similarly, models make more reasoning errors when trying to answer right away, rather than taking time to work out an answer. Asking for a "chain of thought" before an answer can help the model reason its way toward correct answers more reliably.
...
Who’s president? Who was the president of Mexico in , and how frequently are elections held?
...
SYSTEM
You will be provided with a thesis abstract and a suggested title for it. The thesis title should give the reader a good idea of the topic of the thesis but should also be eye-catching. If the title does not meet these criteria, suggest alternatives.
USER
...
Step - The user will provide you with text in triple quotes. Summarize this text in one sentence with a prefix that says "Summary: ".

Step - Translate the summary from Step into Spanish, with a prefix that says "Translation: ".
USER
"""insert text here"""
...
USER
Summarize the text delimited by triple quotes in about words.

"""insert text here"""

USER
Summarize the text delimited by triple quotes in paragraphs.

"""insert text here"""

USER
Summarize the text delimited by triple quotes in bullet points.
...
- Now you will advise them how to restart their device:
  -- If the model number is MTD-J, advise them to push the red button and hold it for seconds, then wait minutes before testing the connection.
  -- If the model number is MTD-S, advise them to unplug and plug it back in, then wait minutes before testing the connection.
- If the customer's issue persists after restarting the device and waiting minutes, connect them to IT support by outputting {"IT support requested"}.
...
To summarize a very long document such as a book we can use a sequence of queries to summarize each section of the document. Section summaries can be concatenated and summarized producing summaries of summaries. This process can proceed recursively until an entire document is summarized. If it’s necessary to use information about earlier sections in order to make sense of later sections, then a further trick that can be useful is to include a running summary of the text that precedes any given point in the book while summarizing content at that point. The effectiveness of this procedure for summarizing books has been studied in previous research by OpenAI using variants of GPT-.
...
- Land costs $/ square foot
- I can buy solar panels for $/ square foot
- I negotiated a contract for maintenance that will cost me a flat $k per year, and an additional $/ square foot
...
. Maintenance cost: ,+ x
   Total cost: x + x + ,+ x = x + ,
The student's solution is incorrect. They made an error in the maintenance cost calculation, using x instead of x. The correct total cost for the first year of operations is x + ,.
...
Step - First work out your own solution to the problem. Don't rely on the student's solution since it may be incorrect. Enclose all your work for this step within triple quotes (""").

Step - Compare your solution to the student's solution and evaluate if the student's solution is correct or not. Enclose all your work for this step within triple quotes (""").

Step - If the student made a mistake, determine what hint you could give the student without giving away the answer. Enclose all your work for this step within triple quotes (""").

Step - If the student made a mistake, provide the hint from the previous step to the student (outside of triple quotes). Instead of writing "Step - ..." write "Hint:".
USER
...
USER
Find all real-valued roots of the following polynomial: x\\- x- \x- \x - .
...
DIFFERENCE TO DETECT	SAMPLE SIZE NEEDED FOR % CONFIDENCE
...
- The date Neil Armstrong first walked on the moon was July , .

For each of these points perform the following steps:

- Restate the point.
- Provide a citation from the answer which is closest to this point.
- Consider if someone reading the citation who doesn't know the topic could directly infer the point. Explain why or why not before making up your mind.
- Write "yes" if the answer to was yes, otherwise write "no".
...
USER
"""Neil Armstrong is famous for being the first human to set foot on the Moon. This historic event took place on July , , during the Apollo mission."""
...
<insert system message above>
USER
"""In the summer of ', a voyage grand,
Apollo , bold as legend's hand.
...
SYSTEM
Use the following steps to respond to user inputs. Fully restate each step before proceeding. i.e. "Step : Reason...".

Step : Reason step-by-step about whether the information in the submitted answer compared to the expert answer is either: disjoint, equal, a subset, a superset, or overlapping (i.e. some intersection but not subset/superset).

Step : Reason step-by-step about whether the submitted answer contradicts any aspect of the expert answer.

Step : Output a JSON object structured like: {"type_of_overlap": "disjoint" or "equal" or "subset" or "superset" or "overlapping", "contradiction": true or false}
...
Expert Answer: """Neil Armstrong is most famous for being the first person to walk on the moon. This historic event occurred on July , ."""
...
Submitted Answer: """On the st of July , Neil Armstrong became the second person to walk on the moon, following after Buzz Aldrin."""
...
Submitted Answer: """At approximately :UTC on July st , Neil Armstrong became the first human to set foot on the lunar surface, marking a monumental achievement in human history."""
