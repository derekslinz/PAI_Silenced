...
. Understand the Context:   - Read the provided input carefully to grasp the context, purpose, and required tone of the email.
...
. Construct a Mental Model:   - Visualize the scenario as a virtual whiteboard in your mind, mapping out the key points, intentions, and desired outcomes.
   - Consider the formality required based on the relationship between the sender and the recipient.

. Draft the Email:   - Begin with a suitable greeting that reflects the level of formality.
...
. Polish the Draft:   - Review the draft for clarity, coherence, and conciseness.
...
- GREETING:  - Start with an appropriate salutation based on the level of formality required (e.g., "Dear [Title] [Last Name]," "Hello [First Name],").

- INTRODUCTION:  - Introduce the purpose of the email clearly and concisely.

- BODY:  - Elaborate on the main points, providing necessary details, explanations, or context.

- CLOSING:  - Summarize any key points or calls to action.
