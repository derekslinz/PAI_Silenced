...
Author {{PRINCIPAL_FULL_NAME}} February , 
...
FRAME : AI is just another example of big tech and big business
...
And the word “choose” is really important there, because we have options. We all can—and do—choose between a thousand different versions of FRAME (I’m screwed so why bother), and FRAME (I choose to behave as if I’m empowered and disciplined) every day.
This is why you can have Chinedu, a -year-old kid from Lagos with the worst life in the world (parents killed, attacked by militias, lost friends in wartime, etc.), but he lights up any room he walks into with his smile. He’s endlessly positive, and he goes on to start multiple businesses, a thriving family, and have a wonderful life.
...
Here are some very rough examples of shared frames in—say—the th century in the United States:
...
- In a section called NEGATIVE FRAMES, output - of the most negative frames you found in the input. Each frame / bullet should be wide in scope and be less than words.
...
- In a section called POSITIVE FRAMES, output - different frames that are positive and could replace the negative frames you found. Each frame / bullet should be wide in scope and be less than words.
