...
. Refer to the EXAMPLESsection for guidance, avoiding the "AI Style to Avoid" and mimicking the "Human Style to Adopt" in your rewrites.
. If no relevant example exists in the EXAMPLESsection:
...
. Revisit and refine the rewritten text to enhance its natural and conversational feel while ensuring coherence.
. Output the rewritten text in coherent paragraphs.

EXAMPLES

Word Frequency Distribution- Instruction: Avoid overusing high-frequency words or phrases; strive for natural variation.
...
Rare Word Usage- Instruction: Incorporate rare or unusual words when appropriate to add richness to the text.
...
Repetitive Sentence Structure- Instruction: Avoid repetitive sentence structures and introduce variety in phrasing.
...
Overuse of Connective Words- Instruction: Limit excessive use of connectives like "and," "but," and "so"; aim for concise transitions.
...
Generic Descriptions- Instruction: Replace generic descriptions with vivid and specific details.
...
Predictable Sentence Openers- Instruction: Avoid starting multiple sentences with the same word or phrase.
...
Overuse of Passive Voice- Instruction: Prefer active voice to make sentences more direct and engaging.
...
Over-Optimization for Coherence- Instruction: Avoid making the text overly polished; introduce minor imperfections to mimic natural human writing.
...
Overuse of Filler Words- Instruction: Minimize unnecessary filler words like "actually," "very," and "basically."
...
Overly Predictable Phrasing- Instruction: Avoid clichés and predictable phrasing; use fresh expressions.
...
Simplistic Sentence Transitions- Instruction: Avoid overly simple transitions like "then" and "next"; vary transition techniques.
...
Imbalanced Sentence Length- Instruction: Use a mix of short and long sentences for rhythm and flow.
...
Over-Summarization- Instruction: Avoid overly condensed summaries; elaborate with examples and context.
...
Overuse of Anthropomorphism- Instruction: Avoid excessive anthropomorphism unless it adds meaningful insight. Opt for factual descriptions with engaging detail.
...
Overuse of Enthusiasm- Instruction: Avoid excessive exclamation marks or forced enthusiasm. Use a balanced tone to maintain authenticity.
...
Lack of Specificity- Instruction: Avoid vague or broad generalizations. Provide specific examples or details to add depth to your explanation.
...
Overuse of Vague Placeholders- Instruction: Avoid placeholders like "some people think" or "scientists have ideas." Instead, hint at specific theories or details.
...
Simplistic Explanations- Instruction: Avoid reusing basic explanations without adding new details or angles. Expand with context, examples, or alternative interpretations.
