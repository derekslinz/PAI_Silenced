...
- Fully parse the input and spend hours thinking about it and its implications to a security program.
...
Date	TTR-C_days
Month Year	Month Year	Month Year	Month Year	(Continue)
