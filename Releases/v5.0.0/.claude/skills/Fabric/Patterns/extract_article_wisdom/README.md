...
```sh
curl -sS https://raw.githubusercontent.com/danielmiessler/fabric/main/Patterns/extract_wisdom/dmiessler/extract_wisdom-../system.md
```

Pull the _user_ prompt directly

```sh
curl -sS https://raw.githubusercontent.com/danielmiessler/fabric/main/Patterns/extract_wisdom/dmiessler/extract_wisdom-../user.md
```
