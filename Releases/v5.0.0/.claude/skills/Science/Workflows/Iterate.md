...
Actions:- [ ] Document the solution
- [ ] Implement in production
- [ ] Set up monitoring
- [ ] Capture learnings for future reference
- [ ] Archive experiment materials

Learnings to Preserve:- [What worked and why]
...
Path : Hypothesis Confirmed - Implement & Monitor
...
Implementation Plan:. [Implementation step ]
. [Implementation step ]
. [Implementation step ]

Monitoring Plan:- Metric to watch: [What]
- Check frequency: [How often]
- Rollback trigger: [If this happens]

Next Cycle:- Goal still applies
- Watch for new issues that emerge
```

Path : Hypothesis Refuted - Try Next
...
Adjustments to Approach:- [Any changes based on what we learned]
```

Path : All Hypotheses Exhausted - Generate New

```markdown
Iteration: Need New Hypotheses

Hypotheses Tested:- H: REFUTED - [why]
- H: REFUTED - [why]
- H: REFUTED - [why]

What We Learned From Failures:- [Pattern in failures]
- [Assumptions that were wrong]

New Direction:- [Insight from failures that suggests new approach]

New Hypotheses to Generate:- Consider orthogonal approaches
...
Path : Inconclusive - Better Experiment Needed

```markdown
Iteration: Inconclusive Results

Why Inconclusive:- [Data quality issues]
- [Sample size too small]
- [Confounding variables]

Improved Experiment Design:- [What to change]
- [How to get cleaner data]

Action:Return to DesignExperiment with refined approach
```

Path : Paradigm Shift - Reframe the Problem

```markdown
Iteration: Paradigm Shift Needed

The Original Frame:[How we were thinking about the problem]

Why It's Wrong:[Evidence that the whole approach is off]

New Frame:[How we should think about it instead]

New Goal:[Revised goal based on new understanding]
...
When to Stop:- Goal is achieved (even partially)
...
The Rule:Set iteration limits upfront. "We will run cycles max, then decide."
...
Before This Cycle:- We believed: [previous understanding]
- We assumed: [previous assumptions]

After This Cycle:- We now know: [updated understanding]
- We've learned: [new knowledge]

Confidence Changes:- [Belief X]: [increased/decreased] because [evidence]
- [Belief Y]: [increased/decreased] because [evidence]

Bayesian Update:- Prior: [what we thought before]
...
Starting State:- Goal: [What we were trying to achieve]
- Hypotheses: [What we were testing]

Experiments Run:- [Experiment ]: [Result]
- [Experiment ]: [Result]

Outcome:- [GOAL ACHIEVED / CONTINUE / PIVOT]

Key Learning:- [Most important insight from this cycle]
...
If Continuing:- Next hypothesis: [Name]
- Next experiment: [Brief description]

If Shipping:- Implementation plan: [Brief]
- Monitoring plan: [Brief]

If Pivoting:- New direction: [Description]
- Why: [What changed]

If Stopping:- Why stopping: [Reason]
- What we learned anyway: [Takeaway]

World Model Update:- [Key belief change]
...
Each cycle should be FASTER than the lastas you learn and refine.
