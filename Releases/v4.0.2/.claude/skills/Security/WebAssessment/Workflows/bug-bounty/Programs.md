...
- See: `../pentest/MasterMethodology.md`
...
- Automation tool docs: `./AutomationTool.md`
- Pentest methodology: `../pentest/MasterMethodology.md`
- Reconnaissance workflow: `../pentest/Reconnaissance.md`
- Exploitation workflow: `../pentest/Exploitation.md`
