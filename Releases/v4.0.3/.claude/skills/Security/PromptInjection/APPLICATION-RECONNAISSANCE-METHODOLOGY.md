...
This testing is authorized under {YOUR_BUSINESS_NAME}'s security assessment engagement.
EOF
```
...
# For: {YOUR_BUSINESS_NAME} Security Practice
...
**Target:** $TARGET_URL
**Date:** $(date)
**Analyst:** {YOUR_BUSINESS_NAME} Security Practice
