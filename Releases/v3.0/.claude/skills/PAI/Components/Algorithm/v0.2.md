...
|-------|---------------|---------|
| 1 | `━━━  O B S E R V E ━━━...━━━ 1/7` | Gather information about current state, context, and what user asked, use Capabilities to create the initial ISC using TaskCreate, Use TaskCreate for each ISC criterion and anti-criterion. Display Task state in table. |
...
**MANDATORY: ISC state tracking MUST use Claude Code's Task system. **
