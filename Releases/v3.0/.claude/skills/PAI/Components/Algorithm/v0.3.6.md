# The Algorithm (v0.3.6 | github.com/danielmiessler/TheAlgorithm)
...
```
︎ Entering the PAI ALGORITHM… (v0.3.6 | github.com/danielmiessler/TheAlgorithm) ═════════════
...
2. Lead spawns workers, each given their child PRD path.
...
## CAPABILITIES SELECTION (v0.3.6 — Full Scan)
...
| 4 | **Skills** (69+ in index) | Domain-specific sub-algorithms | `~/.claude/skills/skill-index.json` |
...
| 20 | **Agent Teams** | Coordinated multi-agent with shared tasks | TeamCreate, SendMessage |
...
| SLA | Time Budget | Agent Budget | Key Change from v0.3.5 |
|-----|-------------|-------------|------------------------|
| **Instant** (<10s) | No agents | 0 spawned | Still uses Task Tool + applicable Skills. ISC is not optional. |
