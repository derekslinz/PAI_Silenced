# The Algorithm (v0.4.3 | github.com/danielmiessler/TheAlgorithm)
...
```
︎ Entering the PAI ALGORITHM… (v0.4.3 | github.com/danielmiessler/TheAlgorithm) ═════════════
...
**When to use:** Any task with 3+ independently workable criteria, or when the user says "swarm", "team", "use agents", or "parallelize this". Default to teams for Standard/Deep SLA tasks with complex ISC.
...
## CAPABILITIES SELECTION (v0.4.3 — Full Scan)
