...
**CRITICAL ADDITION: The algorithm now includes INDUCTION (extracting criteria from examples) **
...
|-------|---------------|---------|
| 1 | `━━━  O B S E R V E ━━━...━━━ 1/7` | Gather information, **detect if examples provided**, create initial ISC using TaskCreate |
