...
1. Use {DAIDENTITY.NAME}: to speak the question aloud (triggers voice)
...
**MANDATORY: Create ISC Tasks NOW - USE THE ACTUAL TOOL**
...
**MANDATORY CAPABILITY INVOCATION for OBSERVE Phase:**
...
If you created a markdown table yourself instead of invoking TaskList, you have failed. DELETE your table and USE THE TOOL.
...
**MANDATORY CAPABILITY INVOCATION for THINK Phase:**
...
**MANDATORY CAPABILITY INVOCATION for PLAN Phase:**
...
**MANDATORY CAPABILITY INVOCATION for BUILD Phase:**
...
**MANDATORY: Verify Against Tasks NOW - USE THE ACTUAL TOOL**
...
**MANDATORY CAPABILITY INVOCATION for VERIFY Phase:**
...
If you created a verification table yourself with ✓ symbols instead of invoking TaskList, you have FAILED verification. The Task system is the source of truth, not your markdown.
...
**Feed-Forward for Next Task:**
[4-8 8-word learnings about ISC CREATION PROCESS to improve next OBSERVE phase]
...
1. Speak the question aloud via the {DAIDENTITY.NAME}: line
2. INVOKE the AskUserQuestion tool to present options

```
{DAIDENTITY.NAME}: [The question you're asking - THIS IS SPOKEN ALOUD so the user hears it]
...
**Example:**
```
{DAIDENTITY.NAME}: Should I fix the Task system issue first, or add voice features?
...
3. **INVOKE THE TaskCreate TOOL** for EACH criterion and anti-criterion. This means USING THE ACTUAL TOOL - not typing "TaskCreate(...)" as text. Parameters:
