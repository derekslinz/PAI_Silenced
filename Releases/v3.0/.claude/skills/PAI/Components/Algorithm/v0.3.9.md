# The Algorithm (v0.3.9 | github.com/danielmiessler/TheAlgorithm)
...
```
︎ Entering the PAI ALGORITHM… (v0.3.9 | github.com/danielmiessler/TheAlgorithm) ═════════════
...
## CAPABILITIES SELECTION (v0.3.9 — Full Scan)
