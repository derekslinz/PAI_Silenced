...
**MANDATORY: Create ISC Tasks NOW**
...
3. **IMMEDIATELY EXECUTE TaskCreate()** for EACH criterion and anti-criterion identified. Do NOT skip this. Do NOT proceed without calling TaskCreate for every single criterion. Use this exact syntax:
   ```
   TaskCreate(
