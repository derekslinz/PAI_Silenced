...
function buildVisualMetaphor(
  ...
  switch (compositionType) {
    ...
    case "dialogue":
      ...
      break;
    case "workshop":
      metaphor = `${characterFocus === "theo" ? "the assistant" : "Both Maya and Theo"} actively building or creating, with elements spreading horizontally showing the process of making something related to ${analysis.theme}`;
      break;
    case "aura":
      metaphor = `${characterFocus === "maya" ? "Maya" : characterFocus === "theo" ? "the assistant" : "The character"} surrounded by a soft, translucent aura bubble containing tiny symbolic icons representing aspects of ${analysis.theme}`;
      break;
  }
