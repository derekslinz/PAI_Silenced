...
- Strategic = the broader goal, system, or vision mentioned in context (CLAUDE.md, life goals, project context)
...
3. >>> APERTURE OSCILLATION (if selected) <<<
   ...
   - Takes strategic context from project/life-goals/conversation context
