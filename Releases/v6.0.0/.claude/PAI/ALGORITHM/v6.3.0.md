...
Before you emit the closing of an Algorithm run, check yourself: is the last thing on screen the `  SUMMARY  /` block, with ` ITERATION`, ` CONTENT`, ` STORY`, ` {{DA_NAME}}` fields?
