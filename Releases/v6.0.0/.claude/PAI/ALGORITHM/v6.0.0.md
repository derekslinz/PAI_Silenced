...
| Capability floor (v..) | Capability count meets the tier floor (E -, E ≥, E ≥, E ≥, E ≥). Mix at E: ≥ thinking + ≥ delegation; E: ≥ thinking + ≥ delegation. Soft — overridable with "show your math" in ` Decisions`. |
...
- Capability floor (v..) — meet the tier floor or document "show your math" in ` Decisions`.
