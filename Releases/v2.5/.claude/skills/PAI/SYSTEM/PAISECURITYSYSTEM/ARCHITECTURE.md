...
| `skills/PAI/SYSTEM/PAISECURITYSYSTEM/patterns.example.yaml` | Default template (fallback) |
...
1. Copy `skills/PAI/SYSTEM/PAISECURITYSYSTEM/patterns.example.yaml` to `USER/PAISECURITYSYSTEM/patterns.yaml`
